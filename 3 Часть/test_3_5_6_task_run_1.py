# по заданию запуск из консоли pytest -v -m "smoke and not beta_users" test_3_5_6_task_run_1.py
import pytest
...
# ответ 2 skipped, 3 deselected, 1 xfailed, 1 warning, 1 error - запускаются тесты 1, 4
